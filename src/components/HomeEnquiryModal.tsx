                    ...
                    <form onSubmit={submit} className="p-6">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            {type === 'TENANT' ? <>
                                ...
                                <label className="text-sm font-medium text-slate-700">Preferred area<input required value={form.preferredArea} onChange={e => setForm({ ...form, preferredArea: e.target.value })} className={inputClass} /></label>
                            </> : <>
