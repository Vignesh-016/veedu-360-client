-- Correct commission calculation in paise for new rent records.
...
BEGIN
 ...
 total:=ROUND(p_amount_due*100)::BIGINT; admin_share:=ROUND(total*v.commission_percentage/100.0)::BIGINT; owner_share:=total-admin_share;
