-- rent_records has no paid_at column in the deployed schema. Payment time is
-- stored in rent_payments.payment_date and exposed by the history RPC as its
-- paid_at result field.
